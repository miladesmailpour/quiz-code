...
function nextQuestion() {
  ...
  for (var i = 0; i < 4; i++) {
    views.quiz.children[1].children[i].setAttribute(
      "style",
      "background-color: var(--font-dark); color: var(--font-light);"
    );
  }
...
function choiceLock(choice, correct, parentEle) {
  ...
  if (correct != choice) {
    for (var i = 0; i < 4; i++) {
      if (
        views.quiz.children[1].children[i].getAttribute("data-multi-choice") ==
        correct
      ) {
        views.quiz.children[1].children[i].setAttribute(
          "style",
        ...
        views.quiz.children[1].children[i].setAttribute(
          "style",
          "background-color: grey; color: var(--font-light);"
        );
      }
    }
  } else {
